...
namespace System_Minimarket_Views
{
    public partial class Form_Suppliers : Form
    {
        ...
        private void Format_su()
        {
            ...
            Dgv_major.Columns[0].HeaderText = "ID_SU";
        ...
        private void Listing_su(string cText)
        {
            try
            {
                Dgv_major.DataSource = B_Suppliers.Listing_su(cText);
                this.Format_su();
            }
            catch (Exception ex)
            {
        ...
        {
            if (string.IsNullOrEmpty(Convert.ToString(Dgv_major.CurrentRow.Cells["id_su"].Value)))
            {
            ...
            else
            {
                ...
                Text_nodocument_su.Text = Convert.ToString(Dgv_major.CurrentRow.Cells["noDocument_su"].Value);
                Text_comanyname_su.Text = Convert.ToString(Dgv_major.CurrentRow.Cells["companyName"].Value);
                ...
                Text_email_su.Text = Convert.ToString(Dgv_major.CurrentRow.Cells["email_su"].Value);
                Text_phone_su.Text = Convert.ToString(Dgv_major.CurrentRow.Cells["phone_su"].Value);
                Text_mobile_su.Text = Convert.ToString(Dgv_major.CurrentRow.Cells["mobile_su"].Value);
                ...
                Text_address_su.Text = Convert.ToString(Dgv_major.CurrentRow.Cells["address_su"].Value);
                ...
                Text_observation_su.Text = Convert.ToString(Dgv_major.CurrentRow.Cells["observation_su"].Value).Trim();
            }
        ...
        private void Listing_tdsc()
        {
            try
            {
                Dgv_type_tdsc.DataSource = B_Suppliers.Listing_tdsc();
                this.Format_tdsc();
            }
            catch (Exception ex)
            {
        ...
        private void Listing_ge()
        {
            try
            {
                Dgv_gender.DataSource = B_Suppliers.Listing_ge();
                this.Format_ge();
            }
            catch (Exception ex)
            {
        ...
        private void Listing_it(string cText)
        {
            try
            {
                Dgv_items.DataSource = B_Suppliers.Listing_it_su(cText);
                this.Format_it();
            }
            catch (Exception ex)
            {
        ...
        private void Listing_di(string cText)
        {
            try
            {
                Dgv_districts.DataSource = B_Suppliers.Listing_di_su(cText);
                this.Format_di();
            }
            catch (Exception ex)
            {
        ...
        private void Btn_save_Click(object sender, EventArgs e)
        {
            ...
            {
                string Rpt = "";
                E_Suppliers oSu = new E_Suppliers();

                oSu.Id_su = this.Id_su;
                oSu.Id_tdsc = this.Id_tdsc;
                oSu.NoDocument_su = Text_nodocument_su.Text.Trim();
                oSu.CompanyName_su = Text_comanyname_su.Text.Trim();
                oSu.Numbers = Text_numpers.Text.Trim();
                oSu.SurNames = Text_surname.Text.Trim();
                oSu.Id_it = this.Id_it;
                oSu.Id_ge = this.Id_ge;
                oSu.Email_su = Text_email_su.Text.Trim();
                oSu.Phone_su = Text_phone_su.Text.Trim();
                oSu.Mobile_su = Text_mobile_su.Text.Trim();
                oSu.Address_su = Text_address_su.Text.Trim();
                oSu.Id_di = this.Id_di;
                oSu.Observation_su = Text_observation_su.Text.Trim();

                Rpt = B_Suppliers.Save_su(guardState, oSu);
                if (Rpt.Equals("OK"))
                {
                    this.Listing_su("%");
        ...
        private void Btn_clear_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (Option == DialogResult.Yes)
                {
                    string Rpt = "";
                    this.Id_su = Convert.ToInt32(Dgv_major.CurrentRow.Cells["id_su"].Value);
                    Rpt = B_Suppliers.Delete_su(this.Id_su);
                    if (Rpt.Equals("OK"))
                    {
                        this.Listing_su("%");
                        this.Id_su = 0;
        ...
        {
            Reports.FormRptSuppliers oRpt4 = new Reports.FormRptSuppliers();
        ...
        {
            this.Listing_su(Text_search.Text.Trim());
        }
